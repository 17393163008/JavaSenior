 ...
 *      总结：
 *      ->左边：lambda参数列表的参数类型可以省略（类型推断）;如果lambda形参列表只有一个，其一对()也可以省略
 *      ->右边：lambda体应该使用一对{}包裹：如果lambda体只有一条执行语句(可能是return语句),可以省略一对{}和return语句
 *
 * 4、Lambda表达式的本质：作为接口的实例
 *
 * 5、如果一个接口中，只声明了一个方法，则这个接口称为函数式接口
